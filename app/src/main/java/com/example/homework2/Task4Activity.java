...
//--Class members---------------------------------
    ...
    private TextView[] tvSymbols =
            new TextView[Task4Activity.SYMBOLS_IN_WORD];
    /**
...
//-- восстанавливаем его -------------------------
            this.word = savedInstanceState.
                    getString(Task4Activity.BUNDLE_KEY_WORD);
            this.curWord = savedInstanceState.
                    getString(Task4Activity.BUNDLE_KEY_CURWORD);
            this.count = savedInstanceState.
                    getInt (Task4Activity.BUNDLE_KEY_COUNT);
...
//--начальному количеству-------------------------
        this.count = Task4Activity.MAX_TRY_COUNT;
...
//-- о конце игры --------------------------------
    ...
    public void onSaveInstanceState(Bundle savedInstanceState)
    {
        ...
        savedInstanceState.putString(Task4Activity.BUNDLE_KEY_WORD, this.word);
        savedInstanceState.putString(Task4Activity.BUNDLE_KEY_CURWORD, this.curWord);
        savedInstanceState.putInt (Task4Activity.BUNDLE_KEY_COUNT, this.count);
    }
}
